...
@pytest.fixture
def sample_person_transfers_dataframe() -> pd.DataFrame:
    """
        Фикстура, возвращающая пример DataFrame для поиска переводов физлицам.
    ."""
    data = {
        "Дата операции": ["2024-01-05", "2024-01-12", "2024-01-19", "2024-01-26", "2024-02-02"],
        "Дата платежа": ["2024-01-06", "2024-01-13", "2024-01-20", "2024-01-27", "2024-02-03"],
        "Описание": ["Иванову И.", "Петрову А.", "Сидорову Б.", "Орлову Г.", "Разное"],
        "Категория": ["Переводы", "Переводы", "Переводы", "Переводы", "Разное"],
        "Сумма платежа": [-100, -200, -150, -300, -250],
    }
